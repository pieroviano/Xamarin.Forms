...
from history entirely, which emptied the prune commit and dropped it — the record is
`docs/plans/history-purge-deleted-files.md` on the `gtk4` branch. What remains is a shared portable
UI abstraction
