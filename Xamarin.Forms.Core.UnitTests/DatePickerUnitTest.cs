...
namespace Xamarin.Forms.Core.UnitTests
{
	public class DatePickerUnitTest : BaseTestFixture
	{
		...
		{
			var datePicker = new DatePicker();
			AssertEx.DoesNotThrow(() => datePicker.SetValue(DatePicker.DateProperty, null));
		...
		public void SetMaxAndMinDateTimeToNow()
		{
			...
			AssertEx.DoesNotThrow(() => datePicker.SetValue(DatePicker.MinimumDateProperty, DateTime.Now));
		}
	}
}
