...
namespace Xamarin.Forms.Core.UnitTests
{
	public class ThicknessTests : BaseTestFixture
	{
		...
		public void HashCode(double l1, double t1, double r1, double b1, double l2, double t2, double r2, double b2)
		{
		...
		public void ImplicitConversionFromSize()
		{
			...
			AssertEx.DoesNotThrow(() => thickness = new Size(42, 84));
			Assert.Equal(new Thickness(42, 84), thickness);

			AssertEx.DoesNotThrow(() => thickness = 42);
