...
namespace Xamarin.Forms.Core.UnitTests
{
	public class RectUnitTests : BaseTestFixture
	{
		...
		{
			Assert.Equal(expected, new Rect(0, 0, w, h).IsEmpty);
		}
		...
		public void TestRectGetHashCode(double x1, double y1, double w1, double h1, double x2, double y2, double w2, double h2)
		{
		...
		public void ShouldBePossibleToConvertRectangleToRect()
		{
			...
			Assert.Equal(rect, (Rect)rectangle);
		}
	}
}
